...
```
### 2. String repeat(int count) 🔁 (Java 11+)
...
## 3. `boolean isEmpty()` vs `boolean isBlank()` 🫙
...
## 6. `String String.join(CharSequence delimiter, CharSequence... elements)` 🔗
...
---
## 7. `boolean matches(String regex)` 🛡️
